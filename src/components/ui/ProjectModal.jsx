...
const ProjectModal = ({ isOpen, onClose, project }) => {
    ...
    return (
        <>
            ...
            <div
                onClick={onClose}
                className="fixed inset-0 bg-graphite/40 backdrop-blur-sm z-[60] flex items-center justify-center p-4 md:p-8 animate-in fade-in duration-300"
            >
                {/* Modal Content */}
                <div
                    onClick={(e) => e.stopPropagation()}
                    className="bg-executive w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-lg shadow-2xl relative flex flex-col md:flex-row animate-in zoom-in-95 duration-300"
                >
                    {/* Close Button */}
                    <button
                        onClick={onClose}
