            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row gap-20 items-start">
                    ...
                    <div className="lg:w-1/3">
                        <h2 className="text-sm font-bold tracking-widest text-steel uppercase mb-4">
                        ...
                        <button className="text-graphite border-b border-graphite pb-1 hover:text-steel hover:border-steel transition-colors duration-300 uppercase text-xs tracking-widest font-medium">
                    ...
                    <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-12">
                        {[
                            ...
                            <motion.div
                                ...
                                className="group"
                            >
                                <div className="h-[1px] w-full bg-mineral mb-6 group-hover:bg-steel transition-colors duration-500" />
